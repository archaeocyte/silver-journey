<template>
    ...
    <div class='nav-bar-wrapper'>
        ...
        <div id='cinema-detail'>
            <div id='left'>
            <p id='cinema-name'>金逸珠江国际影城广州大学城店</p>
            <div id='picture'>
                <img id='grayBG' src='../../assets/images/cinema/grayBG.png' />
                <div id='watermark'>
                <p id='silverJourney'>
                    <span id='s'>S</span>ilver J
                    <img id='o' src='../../assets/images/cinema/o.png' />
                    <span>urney</span>
                </p>
                <p id='slogan'>跟随银屏，开启心旅程</p>
                </div>
            </div>
            </div>
            ...
            <p id='rate'>评分 6.0</p>
            <div id='loc-info'>
                <img id='loc-img' src='../../assets/images/cinema/location.png' />
                <span class='tag'>地址</span>
                <span class='detail'>番禺区大学城GOGO新天地商业广场三层第3A028号</span>
            </div>
            <div id='contact-info'>
                <img id='cont-img' src='../../assets/images/cinema/phone.png' />
                <span class='tag'>电话</span>
                <span class='detail'>020-111222333</span>
            </div>
            <div id='other-infos-boxes'>
                <img class='round-box' src='../../assets/images/cinema/box.png' />
                <img class='round-box' src='../../assets/images/cinema/box.png' />    
            </div>
            <p id='item'>
                <span id='snack'>小食</span>
                <span>3D眼镜</span>
            </p>
            </div>
        </div>
        ...
        <div class='nav-bar-wrapper'>
            ...
            <others-comments class='user-comment comment0'></others-comments>
            <others-comments class='comment1'></others-comments>
            <others-comments class='comment2'></others-comments>
            <others-comments class='comment3'></others-comments>
    ...
    methods: {
        ...
        publish: function() {
            if (this.comments.length <= 200) {
                ...
                for (var i = 1; i < 6; i++) {
                    var idxO = "o" + i      // other-comments images
                    var idxR = i            // self-comments images
                    //console.log(document.getElementById(idxR).src)
                    document.getElementById(idxO).src = document.getElementById(idxR).src
                }
                document.getElementById('critic-name').innerHTML = "电影小天王"
                document.getElementById('mark').innerHTML = document.getElementById('points').innerHTML
